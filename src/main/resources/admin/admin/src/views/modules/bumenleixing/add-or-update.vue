<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="部门类型" prop="bumenleixing">
          <el-input v-model="ruleForm.bumenleixing" 
              placeholder="部门类型" clearable  :readonly="ro.bumenleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="部门类型" prop="bumenleixing">
              <el-input v-model="ruleForm.bumenleixing" 
                placeholder="部门类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='bumenleixing'){
            this.ruleForm.bumenleixing = obj[o];
	    this.ro.bumenleixing = true;
            continue;
          }
        }
      }
