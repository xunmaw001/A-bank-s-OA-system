<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="职务代理人" prop="zhiwudailiren">
          <el-input v-model="ruleForm.zhiwudailiren" 
              placeholder="职务代理人" clearable  :readonly="ro.zhiwudailiren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="职务代理人" prop="zhiwudailiren">
              <el-input v-model="ruleForm.zhiwudailiren" 
                placeholder="职务代理人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="材料证明" prop="cailiaozhengming">
          <file-upload
          tip="点击上传材料证明"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.cailiaozhengming?ruleForm.cailiaozhengming:''"
          @change="cailiaozhengmingUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.cailiaozhengming" label="材料证明" prop="cailiaozhengming">
            <el-button type="text" size="small" @click="download(ruleForm.cailiaozhengming)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qingjiashizhang = true;
          ...
          if(o=='zhiwudailiren'){
            this.ruleForm.zhiwudailiren = obj[o];
	    this.ro.zhiwudailiren = true;
            continue;
          }
          if(o=='qingjiashiyou'){
	    ...
	    this.ro.qingjiashiyou = true;
          ...
          if(o=='cailiaozhengming'){
            this.ruleForm.cailiaozhengming = obj[o];
	    this.ro.cailiaozhengming = true;
            continue;
          }
          if(o=='jinglizhanghao'){
      ...
      this.$http({
		...
		if(json.jinglixingming!=''&&json.jinglixingming){
          ...
          this.$message.error(data.msg);
            ...
            this.qingjialeixingOptions = "事假,病假,工伤假,产假,陪产假,年假,婚假,其他".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
    ...
    cailiaozhengmingUploadChange(fileUrls) {
	this.ruleForm.cailiaozhengming = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
