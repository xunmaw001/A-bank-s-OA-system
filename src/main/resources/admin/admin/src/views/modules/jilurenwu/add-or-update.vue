...
export default {
  ...
  methods: {
	...
	this.ruleForm.renwuxiangqing = this.ruleForm.renwuxiangqing.replace(reg,'../../../springbootk8uc1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jilurenwu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jilurenwuCrossAddOrUpdateFlag = false;
                  this.parent.search();
